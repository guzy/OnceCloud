...
//			print.printf("%1$20s: %2$s\n", "empty", this.empty);
			...
			print.printf("%1$20s: %2$s\n", "currentlyAttached",
					this.currentlyAttached);
//			print.printf("%1$20s: %2$s\n", "statusCode", this.statusCode);
//			print.printf("%1$20s: %2$s\n", "statusDetail", this.statusDetail);
//			print.printf("%1$20s: %2$s\n", "runtimeProperties",
//					this.runtimeProperties);
//			print.printf("%1$20s: %2$s\n", "qosAlgorithmType",
//					this.qosAlgorithmType);
//			print.printf("%1$20s: %2$s\n", "qosAlgorithmParams",
//					this.qosAlgorithmParams);
//			print.printf("%1$20s: %2$s\n", "qosSupportedAlgorithms",
//					this.qosSupportedAlgorithms);
...
//					this.allowedOperations == null ? new LinkedHashSet<Types.VbdOperations>()
//							: this.allowedOperations);
//			map.put("current_operations",
//					this.currentOperations == null ? new HashMap<String, Types.VbdOperations>()
//							: this.currentOperations);
			map.put("VM", this.VM == null ? new VM("OpaqueRef:NULL") : this.VM);
			map.put("VDI", this.VDI == null ? new VDI("OpaqueRef:NULL")
					: this.VDI);
			map.put("device", this.device == null ? "" : this.device);
			map.put("userdevice", this.userdevice == null ? ""
					: this.userdevice);
			map.put("bootable", this.bootable == null ? false : this.bootable);
			map.put("mode", this.mode == null ? Types.VbdMode.UNRECOGNIZED
					: this.mode);
			map.put("type", this.type == null ? Types.VbdType.UNRECOGNIZED
					: this.type);
//			map.put("unpluggable", this.unpluggable == null ? false
//					: this.unpluggable);
...
//			map.put("empty", this.empty == null ? false : this.empty);
			map.put("other_config",
					this.otherConfig == null ? new HashMap<String, String>()
							: this.otherConfig);
			map.put("currently_attached",
					this.currentlyAttached == null ? false
							: this.currentlyAttached);
//			map.put("status_code", this.statusCode == null ? 0
//					: this.statusCode);
//			map.put("status_detail", this.statusDetail == null ? ""
//					: this.statusDetail);
//			map.put("runtime_properties",
//					this.runtimeProperties == null ? new HashMap<String, String>()
//							: this.runtimeProperties);
//			map.put("qos_algorithm_type", this.qosAlgorithmType == null ? ""
//					: this.qosAlgorithmType);
//			map.put("qos_algorithm_params",
//					this.qosAlgorithmParams == null ? new HashMap<String, String>()
//							: this.qosAlgorithmParams);
//			map.put("qos_supported_algorithms",
//					this.qosSupportedAlgorithms == null ? new LinkedHashSet<String>()
//							: this.qosSupportedAlgorithms);
			map.put("metrics", this.metrics == null ? new VBDMetrics(
...
//		public Set<String> qosSupportedAlgorithms;
	 ...
	 */
	public VBD.Record getRecord(Connection c) throws BadServerResponse,
	 ...
	 */
	public static VBD getByUuid(Connection c, String uuid)
	 ...
	 * @return Task
	 */
//	public static Task createAsync(Connection c, VBD.Record record)
//			throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	}
	 ...
	 */
	public static VBD create(Connection c, VBD.Record record)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	...
	public static VBD createOn(Connection c, VBD.Record record, Host host)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VBD.create_on";
		String session = c.getSessionReference();
		Map<String, Object> record_map = record.toMap();
		Object[] method_params = { Marshalling.toXMLRPC(session),
...
//	}
	...
	/**
	 * Destroy the specified VBD instance on ref host.
	 * 
	 */
	public void destroyOn(Connection c, Host host) throws BadServerResponse,
			XenAPIException, XmlRpcException {
		String method_call = "VBD.destroy_on";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
	...
	/**
	 * Change cd-rom for VM.
	 * 
	 * @author Frankee
	 */
	public void mediaChange(Connection c, VDI new_vdi)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VBD.media_change";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(new_vdi) };
		c.dispatch(method_call, method_params);
		return;
	}
...
//	}
	 ...
	 * @return value of the field
	 */
	public VDI getVDI(Connection c) throws BadServerResponse, XenAPIException,
			XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public String getDevice(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
//	public String getUserdevice(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return value of the field
	 */
//	public Boolean getBootable(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return value of the field
	 */
	public Types.VbdMode getMode(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
	public Types.VbdType getType(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
//	public Boolean getUnpluggable(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return value of the field
	 */
//	public Boolean getEmpty(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return value of the field
	 */
//	public Boolean getCurrentlyAttached(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return value of the field
	 */
//	public Long getStatusCode(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return value of the field
	 */
//	public String getStatusDetail(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return value of the field
	 */
//	public String getQosAlgorithmType(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return value of the field
	 */
	public VBDMetrics getMetrics(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 *            New value to set
	 */
	public void setUserdevice(Connection c, String userdevice)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VBD.set_userdevice";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref),
				Marshalling.toXMLRPC(userdevice) };
		c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 *            New value to set
	 */
	public void setBootable(Connection c, Boolean bootable)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VBD.set_bootable";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(bootable) };
		c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 *            New value to set
	 */
	public void setMode(Connection c, Types.VbdMode mode)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VBD.set_mode";
		String session = c.getSessionReference();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(mode) };
		c.dispatch(method_call, method_params);
		return;
	}
	 ...
	 *            New value to set
	 */
//	public void setType(Connection c, Types.VbdType type)
//			throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	}
	 ...
	 *            New value to set
	 */
//	public void setUnpluggable(Connection c, Boolean unpluggable)
//			throws BadServerResponse, XenAPIException, XmlRpcException {
//		String method_call = "VBD.set_unpluggable";
//		String session = c.getSessionReference();
//		Object[] method_params = { Marshalling.toXMLRPC(session),
//				Marshalling.toXMLRPC(this.ref),
//				Marshalling.toXMLRPC(unpluggable) };
//		Map response = c.dispatch(method_call, method_params);
//		return;
//	}
...
//	}
	 ...
	 *            New value to set
	 */
//	public void setQosAlgorithmType(Connection c, String algorithmType)
//			throws BadServerResponse, XenAPIException, XmlRpcException {
//		String method_call = "VBD.set_qos_algorithm_type";
//		String session = c.getSessionReference();
//		Object[] method_params = { Marshalling.toXMLRPC(session),
//				Marshalling.toXMLRPC(this.ref),
//				Marshalling.toXMLRPC(algorithmType) };
//		Map response = c.dispatch(method_call, method_params);
//		return;
//	}
...
//			Map<String, String> algorithmParams) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
//		String method_call = "VBD.set_qos_algorithm_params";
//		String session = c.getSessionReference();
//		Object[] method_params = { Marshalling.toXMLRPC(session),
//				Marshalling.toXMLRPC(this.ref),
//				Marshalling.toXMLRPC(algorithmParams) };
//		Map response = c.dispatch(method_call, method_params);
//		return;
//	}

	/**
	 * Add the given key-value pair to the qos/algorithm_params field of the
	 * given VBD.
	 * 
	 * @param key
	 *            Key to add
	 ...
	 *            Value to add
	 */
//	public void addToQosAlgorithmParams(Connection c, String key, String value)
//			throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	}
	 ...
	 *            Key to remove
	 */
//	public void removeFromQosAlgorithmParams(Connection c, String key)
//			throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * @return Task
	 */
//	public Task ejectAsync(Connection c) throws BadServerResponse,
...
//	}
	 ...
	 * 
	 */
//	public void eject(Connection c) throws BadServerResponse, XenAPIException,
//			XmlRpcException, Types.VbdNotRemovableMedia, Types.VbdIsEmpty {
...
//	}
	 ...
	 * @return Task
	 */
//	public Task insertAsync(Connection c, VDI vdi) throws BadServerResponse,
//			XenAPIException, XmlRpcException, Types.VbdNotRemovableMedia,
//			Types.VbdNotEmpty {
//		String method_call = "Async.VBD.insert";
//		String session = c.getSessionReference();
//		Object[] method_params = { Marshalling.toXMLRPC(session),
//				Marshalling.toXMLRPC(this.ref), Marshalling.toXMLRPC(vdi) };
//		Map response = c.dispatch(method_call, method_params);
//		Object result = response.get("Value");
//		return Types.toTask(result);
//	}
	 ...
	 *            The new VDI to 'insert'
	 */
//	public void insert(Connection c, VDI vdi) throws BadServerResponse,
//			XenAPIException, XmlRpcException, Types.VbdNotRemovableMedia,
//			Types.VbdNotEmpty {
...
//	}
	 ...
	 * @return Task
	 */
//	public Task plugAsync(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * 
	 */
//	public void plug(Connection c) throws BadServerResponse, XenAPIException,
//			XmlRpcException {
...
//	}
	 ...
	 * @return Task
	 */
//	public Task unplugAsync(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException, Types.DeviceDetachRejected,
...
//	}
	 ...
	 * 
	 */
//	public void unplug(Connection c) throws BadServerResponse, XenAPIException,
//			XmlRpcException, Types.DeviceDetachRejected,
//			Types.DeviceAlreadyDetached {
...
//	}
	 ...
	 * @return Task
	 */
//	public Task unplugForceAsync(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * 
	 */
//	public void unplugForce(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	...
	/**
	 * Throws an error if this VBD could not be attached to this VM if the VM
	 * were running. Intended for debugging.
	 * 
	 * @return Task
	 */
//	public Task assertAttachableAsync(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 * 
	 */
//	public void assertAttachable(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 */
	public static Set<VBD> getAll(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	...
	/**
	 * Return a map of VBD references to VBD records for all VBDs known to the
	 * system.
	 * 
