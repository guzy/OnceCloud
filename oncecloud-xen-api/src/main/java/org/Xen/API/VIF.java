...
//					this.allowedOperations == null ? new LinkedHashSet<Types.VifOperations>()
//							: this.allowedOperations);
//			map.put("current_operations",
//					this.currentOperations == null ? new HashMap<String, Types.VifOperations>()
//							: this.currentOperations);
			map.put("device", this.device == null ? "" : this.device);
			map.put("network", this.network == null ? new Network(
					"OpaqueRef:NULL") : this.network);
...
//							: this.qosSupportedAlgorithms);
			map.put("metrics", this.metrics == null ? new VIFMetrics(
					"OpaqueRef:NULL") : this.metrics);
			map.put("MAC_autogenerated", this.MACAutogenerated == null ? false
					: this.MACAutogenerated);
			return map;
		}
...
//		public Set<String> qosSupportedAlgorithms;
	...
	public VIF.Record getRecord(Connection c) throws BadServerResponse,
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static VIF getByUuid(Connection c, String uuid)
	 ...
	 * @return Task
	 */
//	public static Task createAsync(Connection c, VIF.Record record)
//			throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static VIF create(Connection c, VIF.Record record)
			throws BadServerResponse, XenAPIException, XmlRpcException {
	...
	@SuppressWarnings("rawtypes")
	public static VIF createOn(Connection c, VIF.Record record, Host host)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VIF.create_on";
		String session = c.getSessionReference();
		Map<String, Object> record_map = record.toMap();
		Object[] method_params = { Marshalling.toXMLRPC(session),
	...
	/*
	 * this function is used in createBindToPhysicalNetwork 
	 */
	@SuppressWarnings("rawtypes")
	public static VIF _createBindToPhysicalNetwork(Connection c, VIF.Record record, String phynetwork)
			throws BadServerResponse, XenAPIException, XmlRpcException {
		String method_call = "VIF.create_bind_to_physical_network";
		String session = c.getSessionReference();
		Map<String, Object> record_map = record.toMap();
		Object[] method_params = { Marshalling.toXMLRPC(session),
				Marshalling.toXMLRPC(record_map), Marshalling.toXMLRPC(phynetwork) };
		Map response = c.dispatch(method_call, method_params);
		Object result = response.get("Value");
		return Types.toVIF(result);
	}
	...
	/*
	 * create vif bind to the specific physicalnetwork
	 * eg:
	 * phy_network : "ovs0", if it does not exist, function will throw exception.
	 * newVM: Types.toVM(vmuuid)
	 */
	
	public static VIF createBindToPhysicalNetwork(Connection c, VM vm, String phy_network, String mac)
			throws BadServerResponse, XenAPIException, XmlRpcException{
		VIF.Record vifRec = new VIF.Record();
		vifRec.VM = vm;
		vifRec.MTU = 1500l;
		vifRec.MAC = mac;
		VIF vif = _createBindToPhysicalNetwork(c, vifRec, phy_network);
//		vif.set_physical_network(c, vm, phy_network);
		return vif;
...
//	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public Network getNetwork(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public Long getMTU(Connection c) throws BadServerResponse, XenAPIException,
			XmlRpcException {
...
//	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public VIFMetrics getMetrics(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	 ...
	 * @return value of the field
	 */
//	public Boolean getMACAutogenerated(Connection c) throws BadServerResponse,
//			XenAPIException, XmlRpcException {
...
//	}
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static Set<VIF> getAll(Connection c) throws BadServerResponse,
			XenAPIException, XmlRpcException {
	...
	/**
	 * Return a map of VIF references to VIF records for all VIFs known to the
	 * system.
	 * 
	...
	/*
	 * set physical network of vif, need vm is not running
	 */
	public boolean set_physical_network(Connection c, VM vm_ref, String phyNetwork)
			throws BadServerResponse, XenAPIException, XmlRpcException{
			//vm_ref, vif_ref, phy_network
