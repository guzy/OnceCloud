...
@EnableWebMvc
@EnableWebSocket
public class UpXenMessageConfig extends WebMvcConfigurerAdapter implements
		WebSocketConfigurer {
	
	private UpXenMessageWebSocketHandler messageWebSocketHandler;
	private MessageHandshakeInterceptor messageHandshakeInterceptor;

	private UpXenMessageWebSocketHandler getMessageWebSocketHandler() {
		return messageWebSocketHandler;
	}

	@Autowired
	private void setMessageWebSocketHandler(
			UpXenMessageWebSocketHandler messageWebSocketHandler) {
