...
<div class="modal-dialog" style="width:600px; margin-top:100px">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" id="modaltitle">选择要绑定警告策略[${showid}]的虚拟主机资源<a class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" id="resourceRemove"></span></a></h4>
		</div>
		...
		<div class="modal-footer">
			<button id="bindAlarm2VM" class="btn btn-primary" type="button" data-dismiss="modal" disabled>提交</button>
