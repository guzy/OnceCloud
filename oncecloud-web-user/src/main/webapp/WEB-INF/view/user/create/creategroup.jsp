...
<script src="${basePath}js/user/create/creategroup.js"></script>
<div class="modal-dialog" style="margin-top:100px; width:550px">
	<div id="modalcontent" userid="" class="modal-content">
		<div class="modal-header">
			<h4 id="modaltitle">添加分组<a class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove"></span></a></h4>
		</div>
			...
			<form class="form form-horizontal" id="create-form">
				<fieldset>
                    ...
                    <div class="item">
						...
						<div class="controls">
							<input type="color" id="color" name="color" value="#ffffff" style="cursor:pointer; border:solid 0px; background-color:#fff; width:54%">
						</div>
					</div>
                    <div class="item">
		...
		<div class="modal-footer">
			<button id="createGroupAction" type="button" class="btn btn-primary">提交</button>
