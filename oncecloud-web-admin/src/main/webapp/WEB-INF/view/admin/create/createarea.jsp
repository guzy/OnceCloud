	...
	<div id="modalcontent" userid="" class="modal-content">
		<div class="modal-header">
			<h4 id="modaltitle" oldname="" class="modal-title">
				新建区域<a class="close" data-dismiss="modal" aria-hidden="true"><span
			...
			<form class="form form-horizontal" id="create-form">
				<fieldset>
					<div class="item">
						...
						<div class="controls">
							<input type="text" id="area_name" name="area_name" autofocus="">
						</div>
					</div>
					...
					<div id="pwd">
						<div class="item">
							...
							<div class="controls">
								<input type="text" id="area_domain" name="area_domain"
									autofocus="">
							</div>
						</div>
						<div class="item">
							...
							<div class="controls">
								<input type="text" id="area_desc" name="area_desc" autofocus="">
							</div>
						</div>
					</div>
		...
		<div class="modal-footer">
			<button id="createAreaAction" type="button" class="btn btn-primary">提交</button>
