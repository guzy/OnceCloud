    	...
    	<div class="once-toolbar">
            ...
            <div class="btn-group">
				...
				<ul class="dropdown-menu">
					...
					<li><a class="btn-forbidden" id="update" url="${basePath}admin/modal/host/modify"><span class="glyphicon glyphicon-pencil"></span>修改</a></li>
					...
					<li><a class="btn-forbidden" id="register"><span class="glyphicon glyphicon-list-alt"></span>注册</a></li>
				</ul>
			</div>
