...
import com.beyondsphere.service.ContainerPerformanceService;
import com.beyondsphere.service.PerformanceManger;
...
public class PerformanceAction {
	...
	@Resource
	private ContainerPerformanceService conPerformanceService;
	...
	@ResponseBody
	public String container(HttpServletRequest request, @RequestParam String containerName) {
		JSONArray ja = conPerformanceService.getContainerInfos(containerName);
		return ja.toString();
	}
